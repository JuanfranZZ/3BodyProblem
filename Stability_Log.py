...
if __name__ == "__main__":
    ...
    plt.title(r'Estabilidad $V_{Log}\ L_1$')
    ...
    plt.title(r'Estabilidad $V_{Log}\ L_2$')
    ax2.set_ylabel('conds')
    ax.set(xlabel=r"$\mu$")
    lns = a1 + a2
    labels = [l.get_label() for l in lns]
    ...
    plt.title(r'Estabilidad $V_{Log}\ L_3$')
    ax2.set_ylabel('conds')
    ax.set(xlabel=r"$\mu$")
    lns = a1 + a2
    labels = [l.get_label() for l in lns]
    ...
    plt.title(r'Estabilidad $V_{Log}\ L_4$')
    ax2.set_ylabel('conds')
    ax.set(xlabel=r"$\mu$")
    lns = a1 + a2
    labels = [l.get_label() for l in lns]
    ...
    plt.title(r'Estabilidad $V_{Log}\ L_5$')
    ax2.set_ylabel('conds')
    ax.set(xlabel=r"$\mu$")
    lns = a1 + a2
    labels = [l.get_label() for l in lns]
